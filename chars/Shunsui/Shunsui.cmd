...
trigger2 = movehit && random < 150*(AIlevel ** 100)
value = 1800
...
triggerall = p2stateno !=1960
trigger1 = p2bodydist x >= 120
trigger1 = random < 61*(AIlevel ** 100)/2
trigger2 = p2bodydist x > 200
trigger2 = enemynear, movetype = A
trigger2 = random < 205*(AIlevel ** 100)/3
value = 1900
...
trigger1 = (ailevel * 100)
trigger2 = ((stateno = 200) || (stateno = 210) || (stateno = 300))
trigger2 = movehit && (ailevel * 100)
trigger2 = EnemyNear, GetHitVar(HitTime) >= 3
value = 1300
...
[State 0, sword grounds]
type = ChangeState
triggerall = numhelper(11200) < 2
triggerall = statetype != A
triggerall = ailevel > 0 && roundstate = 2
triggerall = ctrl
Triggerall = p2bodydist y = [-60, 10]
triggerall = p2bodydist x = [45, 150]
