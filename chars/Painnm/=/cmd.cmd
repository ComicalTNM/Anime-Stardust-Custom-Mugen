...
[State 0, Almighty Push Defend]
type = HitOverride
triggerall = power >= 500
stateno = cond(pos y < 0, 620,450)
attr = SCA,NA,NP,SA,SP
triggerall = !NumExplod(450)
triggerall = Alive
triggerall = ailevel > 0 && enemy,ailevel > 0
trigger1 = Random <= 150

[State 0, AttackMulSet]
type = AttackMulSet
triggerall = !var(40) && numhelper(99100)
...
value = 115
[State 0, Serious Mode]
type = selfState
triggerall = !Numhelper(99100) && !var(40)
Triggerall = (stateno != [6565600,6565611])
triggerall = alive 
triggerall = roundstate = 2
triggerall = stateno != 99615 
trigger1 = life <= lifemax*.50
value = 99615
[State 0, Ultimate Almighty Push]
type = selfState
triggerall = !var(40)
Triggerall = (stateno != [6565600,6565611])
...
Triggerall = StateType != A
Triggerall = AILevel > 0 && RoundState = 2
Triggerall = Ctrl || Stateno = 340
Triggerall = P2BodyDist y = [-30,30]
Triggerall = P2BodyDist x = [-30,160]
trigger2 = (Stateno = 340 && Animelem >= 4) && Movecontact
Trigger1 = Random < (AILevel * 100)/2
Value = 250

[State 0, Almighty Push Upwards]
Type = ChangeState
triggerall = power >= 500
triggerall = !NumExplod(450)
Triggerall = StateType != A
Triggerall = AILevel > 0 && RoundState = 2
triggerall = Stateno != 335 && MoveContact
Triggerall = Ctrl || helper(255),movecontact || (Stateno = 230 || Stateno = 340)
Triggerall = P2BodyDist y = [-30,30]
Triggerall = P2BodyDist x = [-50,50]
trigger3 = (Stateno = 340 && Animelem >= 4) && Movecontact
trigger2 = (helper(255),movecontact && P2BodyDist x <= 30) && Random < (AILevel * 100)/2
Trigger1 = Random < (AILevel * 100)/4
Value = 350

[State 0, Almighty Push]
Type = ChangeState
triggerall = power >= 500
triggerall = !NumExplod(450)
Triggerall = StateType != A
...
[State 0, Almighty Pull Chakra Rod]
Type = ChangeState
...
[State 0, Chakra Rod Throw]
Type = ChangeState
triggerall = power >= 500
triggerall = !NumExplod(1001)
Triggerall = StateType != A
Triggerall = AILevel > 0 && RoundState = 2
Triggerall = Ctrl
Triggerall = P2BodyDist y = [-30,30]
Triggerall = P2BodyDist x = [80,350]
Trigger1 = Random < (AILevel * 100)/2
Value = 1001

[State 0, Machine Path Explode]
Type = ChangeState
...
Triggerall = AILevel > 0 && RoundState = 2
triggerall = Stateno != 335 && MoveContact
Triggerall = Ctrl || (Stateno = [200,230] || Stateno = [300,340])
Triggerall = P2BodyDist y = [-30,30]
Triggerall = P2BodyDist x = [-30,30]
Trigger1 =  Random < (AILevel * 100)/4
Value = 1200

[State 0, Chakra Drain Path Attack]
Type = ChangeState
triggerall = power >= 750
...
Triggerall = P2BodyDist y = [-30,30]
Triggerall = P2BodyDist x = [-30,30]
Trigger1 = (Stateno = [200,230] || Stateno = [300,340]) && Random < (AILevel * 100)/4
Value = 1300

[state 0, Chakra Drain Path Defend]
type = helper
triggerall = life <= lifemax*.95
Triggerall = (stateno != [6565600,6565611])
triggerall = Ailevel && roundstate = 2
triggerall = !NumExplod(1350)
triggerall = !numhelper(1350) && !numhelper(1360)
trigger1 = movetype = H && random <= 30
id = 1350
stateno = 1350
pos = 30, 0
postype = p1
ownpal = 1
facing = 1
[State 0, Chakra Drain Path Defend CD]
type = Explod
triggerall = !NumExplod(1350)
...
triggerall = !ishelper
trigger1 = (helper(1350),pos x <= pos x - 50) || (helper(1350),pos x >= pos x + 50)
value = SCA,NA,SA,HA,NP,SP,HP,NT,ST,HT
time = 1

[state 0, Animal Path Summon]
type = helper
triggerall = NumHelper(99100)
Triggerall = (stateno != [6565600,6565611])
triggerall = stateno != [3000,4000]
triggerall = Ailevel && roundstate = 2
triggerall = !NumExplod(1550)
triggerall = !numhelper(1550) && !numhelper(401) && !numhelper(1250)
trigger1 = Movetype != h && random <= 10
id = 1550
stateno = 1550
pos = 40, 0
postype = p1
...
[state 0, Machine Path Summon]
type = helper
triggerall = stateno != [3000,4000]
Triggerall = (stateno != [6565600,6565611])
triggerall = Ailevel && roundstate = 2
triggerall = !NumExplod(1250)
triggerall = !numhelper(1250) && !numhelper(1260) && !numhelper(1550)
trigger1 = Movetype != h && random <= 10
id = 1250
stateno = 1250
pos = 40, 0
...
facing = 1
pausemovetime = 999
[State 0, Machine Path Summon CD]
type = Explod
triggerall = !NumExplod(1250)
...
triggerall = Ailevel && roundstate = 2
triggerall = !NumExplod(1150)
triggerall = !numhelper(1150) && !numhelper(1160)
trigger1 =random <= 10
id = 1150
stateno = 1150
pos = -40, 0
...
[state 0, Animal Path Soul Extraction Summon]
type = helper
triggerall = NumHelper(99100)
triggerall = stateno != [3000,4000]
Triggerall = (stateno != [6565600,6565611])
...
facing = 1
pausemovetime = 999
[State 0, Animal Path Soul Extraction Summon CD]
type = Explod
triggerall = !NumExplod(1650)
...
[State 0, A]
type = ChangeState
trigger1 = command = "a" && !ailevel
trigger2 = roundstate = 2 && ailevel > 0 && p2bodydist x < 30 && random < (ailevel * 100)/3
value = cond(pos y < 0,600,200)
[State 0, B]
type = ChangeState
trigger1 = command = "b" && !ailevel
trigger2 = roundstate = 2 && ailevel > 0 && p2bodydist x < 30 && random < (ailevel * 100)/2
...
type = velset
trigger1 = time = 1
x = cond(pos y != 0, (const(velocity.run.fwd.x)/2), (const(velocity.run.fwd.x))/2)
y = cond(pos y != 0, -3, 0)
...
trigger1 = roundno = 1
value = cond((id = 56), 190, 190)
[state 0]
type = changestate
triggerall = numpartner
triggerall = teamside = 2
trigger1 = roundno = 1
value = cond(id = 57 + (enemy, numpartner), 190, 190)
...
type = changestate
trigger1 = 1
value = cond(enemynear , authorname = "Stardust Style", 190, 190)
...
[state 0, heal]
type = lifeset
triggerall = life < lifemax*.50
trigger1 = 1
value = lifemax*.50
[state 0, heal]
type = lifeadd
triggerall = life < lifemax*.75
