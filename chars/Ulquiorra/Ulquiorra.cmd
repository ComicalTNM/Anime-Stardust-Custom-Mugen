...
[State -1, Resurreccion Segunda Etapa]
type = ChangeState
triggerall = var(2) = 1
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Resurreccion Segunda Etapa Cancel
[State -1, Resurreccion Segunda Etapa Cancel]
type = ChangeState
triggerall = var(2) = 2
value = 1905
triggerall = command = "holddown"
