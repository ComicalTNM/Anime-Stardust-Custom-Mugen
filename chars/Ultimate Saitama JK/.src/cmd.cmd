...
trigger1 = time = 1
value = s5000, cond(random < 500, 0, cond(random < 500, 1, 2))

[state 0]
type = null
trigger1 = (var(53) := 23) && ((fvar(35) := 256) && (fvar(36) := 256) && (fvar(37) := 0))

[state 0]
type = changestate
triggerall = (roundstate = 2) && (pos y = 0) && (numpartner)
trigger1 = (stateno = 190195) && (time >= 5)
value = cond((partner, numhelper(98511)), 1600, 1200)
ignorehitpause = 1
[state 0]
type=poweradd
...
[state 0]
type=changestate
triggerall=(roundstate=2)&&(alive)&&(ctrl)
trigger1=((!ailevel)&&(command="a"))
value=cond(pos y!=0,201,200)
[state 0]
type=changestate
triggerall=(roundstate=2)&&(alive)&&(ctrl)
...
trigger1 = (Root,Stateno = 82130) && Root,AnimElem = 4
fvar(7) = 1.01
ignorehitpause = 1
...
type = AngleDraw
trigger1 = 1
scale = Cond((Root,Stateno = [60200,60990]) || (Root,Stateno = [601000,603300]),.84,1),Cond((Root,Stateno = [60200,60990]) || (Root,Stateno = [601000,603300]),.84,1)
ignorehitpause = 1
[state 0]
type = destroyself
trigger1 = time = 15
...
[state 0]
type = changestate
trigger1 = (root, life = 0) || (!playeridexist(root, id)) || (root, Anim = 9999)
...
vel = 0,0
accel = 0,0
removetime = 9999999999999999999999
supermovetime = 300
pausemovetime = 0
scale = 1,1
sprpriority = 5
