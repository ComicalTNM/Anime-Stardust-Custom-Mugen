...
triggerall = stateno != 165
value = 1800;160
trigger1 = command = "SUPER 1A"
trigger2 = command = "SUPER 1B"
...
Triggerall = power >= 2000
value = 1700
trigger1 = command = "SUPER 2A"
trigger2 = command = "SUPER 2B"
triggerall = statetype != A
triggerall = ctrl
;---------------------------------------------------------------------------
[State -1, Doble Hand Tornado]
type = ChangeState
Triggerall = power >= 2000
value = 1600
trigger1 = command = "SUPER 3A"
trigger2 = command = "SUPER 3B"
;triggerall = statetype != A
triggerall = ctrl
;---------------------------------------------------------------------------
...
triggerall = stateno != 165
value = 3000;160
trigger1 = command = "SPECIAL 10";"z"
trigger1 = statetype != A
trigger1 = ctrl
trigger1=pos y=0
;===========================================================================
;---------------------------Special-----------------------------------------
[State -1, Mini Tornado]
type = ChangeState
