...
triggerall = ailevel = 0 && roundstate = 2
value = 3200
triggerall = Var(14)!=0&&Var(15)!=0&&Var(16)!=0&&Var(17)!=0
triggerall = statetype != A
...
type = ChangeState
triggerall = ailevel = 0 && roundstate = 2
value = Cond(Statetype = A,(Cond(Var(16)=1,1901,Cond(Var(16)=2,1905,Cond(Var(16)=4,1908,Cond(Var(16)=3,1912,1800))))),(Cond(Var(14)=1,1900,Cond(Var(14)=2,1904,Cond(Var(14)=4,1907,Cond(Var(14)=3,1911,1400))))))
...
type = ChangeState
triggerall = ailevel = 0 && roundstate = 2
value = Cond(Statetype = A,(Cond(Var(17)=1,1950,Cond(Var(17)=2,1951,Cond(Var(17)=4,1953,Cond(Var(17)=3,1954,1850))))),(Cond(Var(15)=1,1950,Cond(Var(15)=2,1951,Cond(Var(15)=4,1953,Cond(Var(15)=3,1954,1500))))))
...
triggerall = StateNo != 1401&&StateNo != 1501&&StateNo != 1801&&StateNo != 1851
...
trigger1 =  command = "z"
trigger1 = AILevel <=  0
trigger2 = ailevel >5 && (stateno = 1105||stateno =1205)&& movehit && Cond(Var(52)=5,pos y > -40,pos y >= -10)&& Var(52)!=3
trigger3 = stateno = 370 && time = 1 && ailevel > 5 && var(50)=0
trigger4 = stateno = 1805 && moveguarded && time = 25 && ailevel
trigger5 = ailevel && (Var(52)=0||Var(52)=2||Var(52)=1) && random < 20 && time < 5 && enemy,movetype != H && numtarget = 0 && (Cond(Var(52)=1,enemy,pos Y > -100,0))
ignorehitpause = 1
...
triggerall = ailevel = 0 && roundstate = 2
value = 311
trigger1 = command = "b" && command = "holddownfwd"
Triggerall = statetype != A
trigger1 = ctrl
[State -1, A ]
type = ChangeState
