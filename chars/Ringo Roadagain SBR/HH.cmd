...
triggerall = statetype != A
value = 1600
triggerall = command = "QP"
trigger1 = ctrl

[State 0, PowerAdd]
type = PowerAdd
trigger1 = stateno = 1002 && time = 0
value = -4000
...
type = ChangeState
triggerall = ailevel=0
value = cond(numhelper(1001),1005,1000)
