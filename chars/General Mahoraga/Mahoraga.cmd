...
[State -1, Positive Energised SLASH]
type = ChangeState
Triggerall = !Ailevel
Triggerall = power >= 3000
value = 4100
...
Triggerall = !Ailevel
Triggerall = Helper(30992),Var(4) || Helper(30992),Var(15)
triggerall = Helper(3604),Var(40) >= Helper(30992),Var(4) || Helper(30992),Var(15)
;Triggerall = power >= 3000
value = 1000
Triggerall = Command = "holddown"
...
;trigger2 = numhelper(8203) > 0
;---------------------------------------------------------------------------
; Roar Projectile Version
[State -1, Roar Projectile Version]
type = ChangeState
Triggerall = !Ailevel
Triggerall = Helper(30992),Var(10) || Helper(30992),Var(15)
triggerall = Helper(3604),Var(40) >= Helper(30992),Var(10) || Helper(30992),Var(15)
...
trigger2 = numhelper(8203) > 0
;----------------------------------------------------------------------------
[State -1, World Slash Projectile]
type = ChangeState
Triggerall = !Ailevel
triggerall = (Helper(3604),Var(40) >= Helper(30992),Var(13) || Helper(3604),Var(13)) || Helper(30992),Var(15)
Triggerall = power >= Cond(Helper(3604),Var(13),3000,1500)
value = 1100
...
trigger2 = numhelper(8203) > 0
;---------------------------------------------------------------------------
[State -1, Stomp | Max Power]
type = ChangeState
Triggerall = !Ailevel
Triggerall = Fvar(1) >= .4 || Helper(30992),Var(15)
