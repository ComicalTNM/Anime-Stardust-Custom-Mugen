...
Triggerall = statetype != A
trigger1 = ctrl
trigger2 = time >= 8 && (stateno = [17200,17205]) && MoveContact
trigger3 = time >= 8 && (stateno = [17215,17220]) && MoveContact
trigger4 = time >= 12 && (stateno = 17230) && MoveContact
trigger5 = time >= 8 && (stateno = 17285) && MoveContact
trigger6 = time >= 8 && (stateno = 17295) && MoveContact
;---------------------------------------------------------------------------
; SHOOT STYLE - OKLAHOMA SMASH
[State -1, OKLAHOMA SMASH]
type = ChangeState
...
Triggerall = statetype != A
trigger1 = ctrl
trigger2 = time >= 5  && (stateno = [17205,17210]) && MoveContact
trigger3 = time >= 12 && (stateno = [17220,17235]) && MoveContact
trigger4 = time >= 8 && (stateno = 17285) && MoveContact
trigger5 = time >= 8 && (stateno = 17295) && MoveContact
...
Triggerall = statetype = A
trigger1 = ctrl
trigger2 = time >= 5  && (stateno = [17255,17265]) && MoveContact
trigger3 = time >= 8 && (stateno = 17290) && MoveContact
...
Triggerall = statetype != A
trigger1 = ctrl
trigger2 = time >= 8 && (stateno = [17205,17235]) && MoveContact
trigger3 = time >= 8 && (stateno = 17285) && MoveContact
trigger4 = time >= 8 && (stateno = 17295) && MoveContact
...
Triggerall = statetype != A
trigger1 = ctrl
trigger2 = time >= 8 && (stateno = [17205,17210]) && MoveContact
trigger3 = time >= 8 && (stateno = [17220,17235]) && MoveContact
...
trigger1 = ctrl
trigger2 = time >= 5  && (stateno = [17255,17265]) && MoveContact
trigger3 = time >= 5  && (stateno = 17270) && MoveContact
trigger4 = time >= 8 && (stateno = 17290) && MoveContact
...
Triggerall = statetype != A
trigger1 = ctrl
trigger2 = time >= 8 && (stateno = 17210) && MoveContact
trigger3 = time >= 8 && (stateno = 17225) && MoveContact
trigger4 = time >= 8 && (stateno = 17235) && MoveContact
...
Triggerall = statetype != A
trigger1 = ctrl
trigger2 = time >= 10 && (stateno = 17205)
trigger3 = time >= 10 && (stateno = 17225)
;----------------------------------------------------------------------------
[State -1, Down + A]
type = ChangeState
triggerall = var(2) = 1
