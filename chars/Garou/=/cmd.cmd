...
trigger2 = (ailevel) && (roundstate = 2) && (ctrl) && ((p2bodydist x >= 200) && (random < (ailevel * 1) / 5))
...
trigger3 = (ailevel) && ((enemynear, vel x = 0) || (enemy, vel x = 0)) && ((p2bodydist x >= 110 + (random % 20)) && (random < (ailevel * 3)))
value = 100
[state > back jump]
type = changestate
triggerall = name != "johnny joestar"
...
trigger2 = ((ailevel) && (p2bodydist x = [16, 24]) && (p2bodydist y = [-10, 5]) && (random < (ailevel * 5)))
...
trigger1 = ((!ailevel) && (command = "s"))
trigger2 = ((ailevel) && (p2bodydist x = [-8 + (random % 4), 44]) && (random < (ailevel * 2)))
...
trigger2 = ((ailevel) && (life <= 800) && (cond(life < lifemax / 2.5, (random < (ailevel * 3)), random < ((ailevel * 1) / 4))))
trigger3 = ((ailevel) && (var(2) != 0) && (p2bodydist x >= 300) && (random < (ailevel * 1)))
...
trigger1 = (((gametime % 25 = 0) && ((numhelper(99100) && ((helper(30990), var(1)) = 4)))) || ((gametime % 30 = 0) && (numhelper(99100))))
...
trigger1 = roundstate = 0
var(57) = cond(ailevel, cond(random % 1 = 0, 1 + (random % 40), 1), 1)
...
type = ChangeState
triggerall = var(14) = 2
value = Cond(Pos Y >= 0,2200,2600)+Var(11)
triggerall = time > 2
Triggerall = Helper(81001),MoveHit
trigger1 = command = "a"
...
type = ChangeState
triggerall = var(14) = 2
value = Cond(Pos Y >= 0,2300,2600)+Var(11)
Triggerall = Helper(81001),MoveHit
triggerall = time > 2
trigger1 = command = "b"
trigger2 = roundstate = 2 && ailevel > 0 && random < (ailevel * 100)
...
type = ChangeState
triggerall = var(14) = 2
value = Cond(Pos Y >= 0,2400,2600)+Var(11)
triggerall = time > 2
Triggerall = Helper(81001),MoveHit
trigger1 = command = "c"
trigger2 = roundstate = 2 && ailevel > 0&& random < (ailevel * 100) && Pos Y >= 0
