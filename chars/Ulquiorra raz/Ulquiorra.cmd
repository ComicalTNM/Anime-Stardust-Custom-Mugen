...
type = ChangeState
triggerall = !ailevel
triggerall = (power >= 3000) && (command = "ULTIMATE 1") && (statetype != A) && (teammode != simul)
trigger1 = ctrl
value = 3000
...
type = ChangeState
triggerall = !ailevel
triggerall = (var(5) = 0) && (power >= 250) && (command = "b") && (command = "c") ;&& (statetype != A)
trigger1 = ctrl
value = 350
...
type = ChangeState
triggerall = !ailevel
triggerall = (power >= 250) && (command = "s") && (command = "holddown") && (statetype != A)
trigger1 = ctrl || stateno = [200,440]
value = 667

[State -1, A]
type = ChangeState
triggerall = !ailevel
triggerall = (command = "a") && command != "holdback" && (statetype != A)
trigger1 = ctrl
value = 200
