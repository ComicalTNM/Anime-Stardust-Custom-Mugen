...
[State -1, Trump Card I (Death Slice)]
type = ChangeState
...
[State -1, Trump Card III (Quick Slicer)]
type = ChangeState
...
[State -1, Flash Run - Double Strike]
type = ChangeState
...
[State -1, Heaven Mark - Sacred Eightfold Thrust]
type = ChangeState
...
[State -1, Death Mark - Eternal Cuts]
type = ChangeState
...
[State -1, Down B+C]
type = ChangeState
triggerall = (var(30) = 1) && (power >= 250) && (command = "b") && (command = "c") && (command = "holddown") && (statetype != A)
trigger1 = ctrl
value = 370
...
[State -1, A+C]
type = ChangeState
triggerall = (var(30) = 1) && (power >= 250) && (command = "a") && (command = "c") && (statetype != A)
trigger1 = ctrl
value = 450
