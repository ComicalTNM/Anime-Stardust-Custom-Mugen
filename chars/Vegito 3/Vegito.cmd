...
Triggerall = enemy,name = "Fused Zamasu V2"
triggerall = enemy,authorname = "Knightmare"
...
value = Cond(Statetype = A,1101,1100)
...
trigger6 =  stateno = 1205 && movecontact
trigger7 =  stateno = 1210 && movecontact
trigger8 =  stateno = 1400 && time > 30
trigger9 =  stateno = 1401 && time > 25
trigger10 =  stateno = 1505 && movecontact
;---------------------------------------------------------------------------
[State -1, Vanish:No Wallbounce]
type = ChangeState
triggerall = enemy,movetype != H
triggerall = ailevel = 0 && roundstate = 2
Triggerall = power >= 1000
...
;---------------------------------------------------------------------------
; Split Finger Shot
[State -1, Split Finger Shot]
type = ChangeState
triggerall = ailevel = 0 && roundstate = 2
Triggerall = power >= 500
value = Cond(Statetype = A,1401,1400)
