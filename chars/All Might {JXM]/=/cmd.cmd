...
;[State 0, TargetState]
;type = TargetState
;triggerall = enemy,stateno != 91029
;trigger1 = movehit = 1
;value = 991029
...
trigger1 = 1
text = "P2 Bodydist x = %f  prevstateno = %d, var(37) = %d"
params = P2BodyDist x,PrevStateNo,var(37)

[State 0, Parry]
type = selfstate
triggerall = name = "All Might [JXM]"
triggerall = AILevel && RoundState = 2 && alive
triggerall = movetype = H && enemy,HitDefAttr = SCA,NA,AT
triggerall = statetype != L && P2MoveType = A 
triggerall = p2bodydist x < 30 && stateno != 915
triggerall = numexplod(245677) = 0
trigger1 = random <= 10
trigger1 = (gethitvar(hitcount) <= 5 || gethitvar(damage) < 40)
trigger2 = random <= 20
trigger2 = stateno = [120,155]
trigger2 = (gethitvar(hitcount) >= 5 || gethitvar(damage) < 40)
value = 915
ctrl = 0
...
triggerall = movetype = H && enemy,HitDefAttr = SCA,NA,AT
triggerall = statetype != L && P2MoveType = A 
triggerall = p2bodydist x < 30 && stateno != 106
triggerall = numexplod(245678) = 0
trigger1 = random <= 10
trigger1 = (gethitvar(hitcount) >= 5 || gethitvar(damage) < 40)
trigger2 = Var(37) 
trigger2 = random <= 15
trigger2 = (gethitvar(hitcount) <= 10 || gethitvar(damage) < 40)
trigger3 = random <= 25
trigger3 = life <= lifemax*0.3
trigger3 = (gethitvar(hitcount) >= 5 || gethitvar(damage) > 60)
value = 106;cond(p2bodydist x < 30,106,cond(random < 500,107,109))
ctrl = 0
...
[state 0]
type = targetbind
trigger1 = AnimElemTime(3) <= 0 && MoveHit && stateno = [200,620]
Pos = 20,0
ID = 1234
...
;Value = Cond(Time >= 50,-LifeMax/100,-LifeMax/1000)
;ID = 33042
...
[State 0, Helper]
Type = Helper
Trigger1 = NumHelper(1701) = 0 && Var(37) = 1 && Alive
HelperType = Normal
ID = 1701
Stateno = 1701
Pos = 0,0
...
type = selfState
trigger1 = var(37) = 0
triggerall = alive && name = "All Might [JXM]"
...
Type = VarSet
Trigger1 = Stateno = 99615
V = 37
Value = 1

[State 0, Attack]
type = AttackMulSet
trigger1 = var(37) = 0 && enemy,AuthorName != "Stardust Style"
value = 1.4

[State 0, Attack]
type = AttackMulSet
trigger1 = var(37) = 1 && enemy,AuthorName != "Stardust Style"
value = 2.3
...
Trigger1 = Random < (AILevel * 200) && (p2bodydist x > 30)
Value = cond(random < 500,100,60)

[state 0,turn]
type = turn
trigger1 = movetype = a && p2dist x < 0 && !time

[State 0, PosSet]
type = PosSet
trigger1 = stateno = [200,450]
trigger2 = stateno = 3000
trigger3 = stateno = [120,190]
y = 0
...
[state 0, Break From Combo (Guard)]
type = hitoverride
triggerall = var(37) = 1
triggerall = (!EnemyNear,HitDefAttr = SCA,HA,SA,HP,HT) && (ailevel)
trigger1 = random < 30
stateno = 120
time = 2
attr = SCA,AT,AA,AP
...
[State 0, NotHitBy]
type = NotHitBy
trigger1 = time < 120 && stateno = [1000,3300]
value = SCA,NA,SA,HA,NP,SP,HP,NT,ST,HT
time = 1
...
triggerall = ((movetype = h) || (numhelper(98001) = 1))
triggerall = enemy, numhelper(80015) = 0
trigger1 = (p2bodydist x = [-47 + (random % 4), 50 + (random % 10)]) && cond(life<100 , 1, (random < 40 ))
attr = sca, na, np, nt, sa, sp, st
stateno = 99685
time = 5
ignorehitpause = 1
...
value = cond(movetype = h, (1 / cond(numpartner > 0, (numpartner + 1), 2)), (2 / cond(numpartner > 0, (numpartner + 1), 4)))
ignorehitpause = 1
[state > energy attack]
type = poweradd
...
[State 0, LifeAdd]
type = LifeAdd
triggerall = life != 0 && roundstate = 2
triggerall = gametime%18 = 0 && life <= lifemax*0.5
trigger1 = var(37) ;&& NumHelper(25850) = 0
value = 1
absolute = 1
...
type = ChangeState
triggerall = time >= 0
trigger1 = p2bodydist y < -10 && pos y < 0 && enemy,pos y < 0 && p2bodydist x < 30
value = 600
...
type = velset
trigger1 = time >= 15
x = 10; cond(p2bodydist x <= 80, 4.5, 8.5)
...
[State 0, ChangeAnim]
type = ChangeAnim
trigger1 = ishelper(99450)
value = 99991
[State 0, ChangeAnim]
type = ChangeAnim
trigger1 = ishelper(99452)
value = 99992
[State 0, ChangeAnim]
type = ChangeAnim
trigger1 = ishelper(99451)
value = 99993
[State 0, ChangeAnim]
type = ChangeAnim
trigger1 = ishelper(99453)
value = 99991
[State 0, ChangeAnim]
type = ChangeAnim
trigger1 = ishelper(99454)
value = 99992

[State 0, HitDef]
Type = HitDef
triggerall = roundstate = 2
triggerall = ishelper(99450)
triggerall = playeridexist(root,var(52))
Trigger1 = 1 ;Cond(IsHelper(21),Timemod = 50,0,Cond(IsHelper(20),(Time = 55) || (Time = 115) || (Time = 145) || (Time = 200) || (Time = 245) || (Time = 295) || (Time = 325),(Time = 125) || (Time = 225) || (Time = 325)))
Attr = A, HP
HitSound = -1
GuardSound = -1
P1Stateno = 99451
...
type = posset
trigger1 = ishelper(99450)
trigger1 = playeridexist(root,var(52))
x = playerid(root,var(52)),pos x
y = playerid(root,var(52)),pos y - 20
ignorehitpause = 1

[State 0, HitDef]
Type = HitDef
triggerall = roundstate = 2
triggerall = ishelper(99451)
triggerall = playeridexist(root,var(53))
Trigger1 = 1 ;Cond(IsHelper(21),Timemod = 50,0,Cond(IsHelper(20),(Time = 55) || (Time = 115) || (Time = 145) || (Time = 200) || (Time = 245) || (Time = 295) || (Time = 325),(Time = 125) || (Time = 225) || (Time = 325)))
Attr = A, HP
HitSound = -1
GuardSound = -1
...
type = posset
trigger1 = ishelper(99451)
trigger1 = playeridexist(root,var(53))
x = playerid(root,var(53)),pos x
y = playerid(root,var(53)),pos y - 20
ignorehitpause = 1

[State 0, HitDef]
Type = HitDef
triggerall = roundstate = 2
triggerall = ishelper(99452)
triggerall = playeridexist(root,var(54))
Trigger1 = 1 ;Cond(IsHelper(21),Timemod = 50,0,Cond(IsHelper(20),(Time = 55) || (Time = 115) || (Time = 145) || (Time = 200) || (Time = 245) || (Time = 295) || (Time = 325),(Time = 125) || (Time = 225) || (Time = 325)))
Attr = A, HP
HitSound = -1
GuardSound = -1
...
type = posset
trigger1 = ishelper(99452)
trigger1 = playeridexist(root,var(54))
x = playerid(root,var(54)),pos x
y = playerid(root,var(54)),pos y - 20
ignorehitpause = 1

[State 0, HitDef]
Type = HitDef
triggerall = roundstate = 2
triggerall = ishelper(99453)
triggerall = playeridexist(root,var(51))
Trigger1 = 1 ;Cond(IsHelper(21),Timemod = 50,0,Cond(IsHelper(20),(Time = 55) || (Time = 115) || (Time = 145) || (Time = 200) || (Time = 245) || (Time = 295) || (Time = 325),(Time = 125) || (Time = 225) || (Time = 325)))
Attr = A, HP
HitSound = -1
GuardSound = -1
...
type = posset
trigger1 = ishelper(99453)
trigger1 = playeridexist(root,var(51))
x = playerid(root,var(51)),pos x
y = playerid(root,var(51)),pos y - 20
ignorehitpause = 1

[State 0, HitDef]
Type = HitDef
triggerall = roundstate = 2
triggerall = ishelper(99454)
triggerall = playeridexist(root,var(55))
Trigger1 = 1 ;Cond(IsHelper(21),Timemod = 50,0,Cond(IsHelper(20),(Time = 55) || (Time = 115) || (Time = 145) || (Time = 200) || (Time = 245) || (Time = 295) || (Time = 325),(Time = 125) || (Time = 225) || (Time = 325)))
Attr = A, HP
HitSound = -1
GuardSound = -1
...
type = posset
trigger1 = ishelper(99454)
trigger1 = playeridexist(root,var(55))
x = playerid(root,var(55)),pos x
y = playerid(root,var(55)),pos y - 20
ignorehitpause = 1
;--------------------------------------------
[StateDef 99451]
Type = U
...
[state 0]
type = targetstate
triggerall = (Root,Stateno = [1150,1155])||(Root,Stateno = [1050,1099])||(Root,Stateno = 230)||(Root,Stateno = 440)||(Root,Stateno = [1550,1599])||Root,Stateno = 230||Root,Stateno = 1000
triggerall = Root,P2dist x = [-40,40]
triggerall = Root,P2dist y = [-40,40]
Triggerall = Enemy,Stateno != 91029
Trigger3 = ((Enemy,Stateno = [5220,5221])||Enemy,Stateno = 5120||(Enemy,Stateno = [100,116])||Enemy,Stateno = 68||Enemy,Stateno = 72||Enemy,Stateno = 99600||Enemy,Stateno = 99685||Enemy,Stateno = 60||Enemy,Stateno = 70)
trigger1 = ((Enemy,Stateno = [200+Enemy,Var(11),299+Enemy,Var(11)])||(Enemy,Stateno = [300+Enemy,Var(11),499+Enemy,Var(11)])||(Enemy,Stateno = [600+Enemy,Var(11),650+Enemy,Var(11)])||Enemy,Stateno = 1000+Enemy,Var(11)||Enemy,Stateno = 1100+Enemy,Var(11)||Enemy,Stateno = 1200+Enemy,Var(11)||Enemy,Stateno = 1300+Enemy,Var(11)||Enemy,Stateno = 1400+Enemy,Var(11)||Enemy,Stateno = 1500+Enemy,Var(11)||Enemy,Stateno = 1600+Enemy,Var(11))
trigger2 = ((Enemy,Stateno = [200,299])||(Enemy,Stateno = [300,499])||(Enemy,Stateno = [600,650])||Enemy,Stateno = 1000||Enemy,Stateno = 1100||Enemy,Stateno = 1200||Enemy,Stateno = 1300||Enemy,Stateno = 1400||Enemy,Stateno = 1500||Enemy,Stateno = 1600)
Value = 91029
