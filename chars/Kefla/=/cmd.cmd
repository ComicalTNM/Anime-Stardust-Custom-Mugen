...
trigger1 = (!ailevel) && ((command != "holddown") && (command != "holdfwd") && (command = "holdback") && (command = "x"))
...
type = changestate
triggerall = (roundstate = 2) && (ctrl) && (pos y = 0)
trigger1 = (!ailevel) && ((command != "holdback") && (command != "holdfwd") && (command = "holddown") && (command = "s"))
