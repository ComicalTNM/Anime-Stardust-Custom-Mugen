...
[Statedef -1]
;---------------------------------------------------------------------------
[State -1,Dramatic Finish]
type = ChangeState
triggerall = ailevel = 0 && roundstate = 2
Triggerall = power >= 3000
Triggerall = ((enemy,name = "Cell" && enemy,authorname = "Doly P29")||(enemy,name = "Perfect Cell" && enemy,authorname = "Knightmare")||(enemy,name = "Cell" && enemy,authorname = "Mikel8888"))
...
type = ChangeState
Triggerall = power >= 500
triggerall = Cond(numhelper(1550),helper(1550),stateno != 1560,1)
triggerall = ailevel = 0 && roundstate = 2
value = Cond(numhelper(1550),1501,1500)
Triggerall = statetype != A
...
[State -1, Double Jump]
type = ChangeState
triggerall = Cond(stateno = 80,vel y > -1,1)
triggerall = ailevel = 0 && roundstate = 2
triggerall = numexplod(45) = 0
triggerall = numexplod(46) = 1
value = 45
Triggerall = statetype = A
...
trigger6 =  stateno = [1000,1290]
trigger6 =  movecontact
trigger7 =  stateno = [1900,1990]
...
triggerall = ailevel = 0 && roundstate = 2
value = 230
trigger1 = command = "a" && command = "holddownfwd"
Triggerall = statetype != A
trigger1 = ctrl
...
trigger3 = stateno = 1805 && moveguarded && time = 25 && ailevel
