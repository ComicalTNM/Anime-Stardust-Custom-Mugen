...
[State -1, Last Chance of the Water Breathing]
type = ChangeState
...
[State -1, Mizuguruma]
type = ChangeState
triggerall = (power >= 1000) && (command = "SPECIAL 3") && (!ailevel) ;&& (statetype != A)
trigger1 = ctrl
trigger2 = numhelper(700) > 0
value = 1200
...
[State -1, Mark of a Demon Slayer]
type = ChangeState
triggerall = ailevel=0 
triggerall = !numexplod(1650)
triggerall = !ishelper
triggerall = (life <= lifemax/3) && (power >= 1500) && (command = "holddown") && (command = "s") && (statetype != A)
trigger1 = ctrl
trigger2 = numhelper(700) > 0
value = 1800
;===========================================================================
