...
;SUPERS:
;===========================================================================
; Ultimate Form: Janken Gu
[State -1, Ultimate Form: Janken Gu]
type = ChangeState
triggerall = var(3) = 0
...
trigger3 = stateno = 300 || stateno = [200,220]
trigger3 = movehit
;---------------------------------------------------------------------------
; Down A
[State -1, Down A]
...
trigger3 = stateno = 300 || stateno = [300,310]
trigger3 = movehit
;---------------------------------------------------------------------------
; Down B
[State -1, Down B]
...
Triggerall = power >= 1000
value = 1600
triggerall = statetype!=A && (command = "back_a") && power >= 750
