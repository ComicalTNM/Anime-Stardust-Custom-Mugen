...
[State 0, Super Armor - Helper]
type = Helper
Trigger1 = NumHelper(1130)
triggerall = !NumHelper(7980)
name = "Super Armor - Helper"
ID = 7980
stateno = 7980
pos = 0,0
postype = p1
...
[State 0, NotHitBy]
Type = NotHitBy
Trigger1 = NumHelper(7980) || NumHelper(21130)
...
type = PalFX
Trigger1 = NumHelper(7980) || NumHelper(21130)
Trigger1 = !((Helper(7980), Time||Helper(21130), Time)) && (Helper(7980), GetHitVar(Damage) || Helper(21130), GetHitVar(Damage))
time = 20
add = 50,50,50
mul = 256,256,256
sinadd = 20,20,20,20
...
;persistent =
;-------------------------------------------------------------------------------
; Superpause override helper
[State 0, helper]
type = Helper
Triggerall = Var(30)
triggerall = movetype != H
triggerall = numhelper(565) = 0
triggerall = numhelper(5601) = 0
triggerall = power >= 1000
trigger1 = enemynear,name = "Dio Brando"
trigger1 = enemynear,stateno = 1100
trigger1 = enemynear,time = [60,65]
trigger2 = enemynear,name = "Jotaro Kujo"
trigger2 = enemynear,stateno = 1100
trigger2 = enemynear,time = [60,70]
trigger3 = partner,name = "Dio Brando"
trigger3 = partner,stateno = 1100
trigger3 = partner,time = [60,65]
trigger4 = enemynear,name = "Diavolo"
trigger4 = enemynear,stateno = 1300 || enemynear,stateno = 1200
trigger4 = enemynear,time = [25,35]
trigger5 = enemynear,name = "Kakyoin Noriaki"
trigger5 = enemynear,stateno = 3000
trigger5 = enemynear,time = [95,105]
trigger6 = enemynear,name = "Enrico Pucci"
trigger6 = enemynear,stateno = 221809
trigger6 = enemynear,time = [40,50]
trigger7 = enemynear,name = "Kira(Kosaku Kawajiri)"
trigger7 = enemynear,stateno = 40000
trigger7 = enemynear,time = [0,4]
trigger8 = enemynear,name = "Jotaro Kujo"
trigger8 = enemynear,stateno = 1300
trigger8 = enemynear,time = [44,45]
trigger9 = enemynear,name = "Diavolo"
trigger9 = enemynear,stateno = 3000
trigger9 = enemynear,time = [100,105]
trigger10 = enemynear,name = "Thanos [Kuro]"
trigger10 = enemynear,stateno = 11000
trigger10 = enemynear,time = [80,85]
helpertype = Normal
name = "Override Superpause"
ID = 565
stateno = 565
pos = 0,0
postype = p1
...
; Give root superpausetime
[State give superpausetime, SuperPause]
type = SuperPause
triggerall = movetype != H
triggerall = numhelper(5601) = 0
triggerall = numhelper(565) = 1
trigger1 = helper(565),time < 2
time = 21
anim = -1
sound = -1
pos = 0,0
...
[State -3, VarSet - Sharingan Mode]
type = VarSet
trigger1 = numhelper(5601) = 1
v = 22
value = 1

[State -3, VarSet - Sharingan Mode]
type = VarSet
trigger1 = numhelper(5601) = 0
trigger2 = 0;life = 0
trigger3 = stateno = 181 && time = 200
trigger4 = stateno = 170 && time = 200
v = 22
value = 0
...
time = 0
movetime = 0
[State cancel pausetime, SuperPause]
type = SuperPause
triggerall = movetype = H
triggerall = prevstateno = 11000
trigger1 = time = 0
...
postype = p1
facing = 1
keyctrl = Cond(AILevel,1,0)
ownpal = 0
supermovetime = 0
pausemovetime = 0

[State 0, ASSIST ACTIVATION]
type = VarSet
trigger1 = 1
v = 6    
value = 3
...
Triggerall = Stateno != 253000
triggerall = Random <= 1
triggerall = power >= 1000
Triggerall = Alive
triggerall = Stateno != 1822
triggerall = !Var(30)
triggerall = !NumHelper(1564)
Trigger1 = Var(59)
HelperType = Normal
ID = 1564
Stateno = 1564
...
[State -3, Speed]
type = ChangeAnim
triggerall = Stateno != 3100 && Stateno != 3000
Triggerall = Var(59) && !Var(30) || Var(48) && !Var(59)
triggerall = anim != [1000,3099]
triggerall = anim != 500
...
[state -2,]
type = hitoverride
trigger1 = Random <= Cond(Var(48),15,Cond(Var(2),25,Cond(Var(59),30,Cond(Var(30),35,5))))
stateno = Cond(statetype = A,132,130)
time = 2
...
[state -2,]
type = hitoverride
Trigger1 = Var(59) && !Var(30) && Random <= 20 
stateno = 106
time = 2
attr = SCA,NA,SA,HA,NP,SP,HP,NT,ST,HT
slot = 1
...
[State 0, ChangeState]
Type = ChangeState
Triggerall = (enemy,numproj = 0) && (Stateno != 60) && (Stateno != 65) && (Stateno != 70) && (AILevel > 0) && (roundState = 2) && (ctrl) && (P2BodyDist x >= 200 || P2BodyDist y <= -160)
Trigger1 = Random < (AILevel * 100)/2
Value = 60

[State 0, ChangeState]
Type = ChangeState
Triggerall = StateType = A && (enemy,numproj = 0) && (Stateno != 60) && (Stateno != 65) && (Stateno != 70) && (AILevel > 0) && (roundState = 2) && (ctrl) && (P2BodyDist x > 100)
Trigger1 = Random < (AILevel * 100)/2
Value = Cond(Pos Y >= 0,100,110)

[State 0, Run Atras]
Type = ChangeState
Triggerall = (Stateno != 60) && (Stateno != 65) && (Stateno != 70) && (AILevel > 0) && (roundState = 2) && (ctrl) && (P2BodyDist x < 100) && (backedgebodydist > 50) && (P2MoveType = A)
...
[State 0, C]
type = selfstate
Triggerall = !numhelper(451) && !NumHelper(450) && !NumHelper(452)
triggerall = statetype != A
triggerall = ailevel > 0 && roundstate = 2
triggerall = ctrl
...
;Triggerall = P2BodyDist x > Cond(Enemy,StateType = L,40,100)
;Triggerall = StateType != A
;Trigger1 = Random < (AILevel*100)/3
...
;Trigger3 = Enemy,PrevStateno = 500 || Enemy,PrevStateno = 115
...
triggerall = StateType = S
value = Cond(Random >= 750,99600,106)
ctrl = 0
...
Trigger1 = Cond(Power >= 1500,Random < (AILevel * 100),Random < (AILevel * 100)/2)
Trigger2 = P2BodyDist x = [150,400]
Trigger2 = Cond(Power >= 1500,Random < (AILevel * 100)/2,Random < (AILevel * 100)/4)
Value = Cond(Var(2),Cond(Random >= 500,1600,Cond(Power >= 2000 && Random >= 500,1800,1900)),Cond(Random >= 500,Cond(Random >= 500,1200,Cond(Random >= 500,1400,1000)),Cond(Random >= 500,1300,Cond(Random >= 500,1400,1100))))

[State 0, Mostly all specialst]
Type = ChangeState
Triggerall = StateType != A
Triggerall = Power >= 1000
Triggerall = AILevel > 0 && RoundState = 2
...
[state 0, Down C]
type=changestate
triggerall=(ctrl=1||stateno=30||stateno=52||stateno=101||stateno=501)&&roundstate=2&&alive=1
triggerall=statetype=s
triggerall=pos y>=0
triggerall=ailevel>0
trigger1=random<ifelse(enemy,ailevel=0,50,500)
triggerall = power >= 1000
trigger1=((p2bodydist x=[-50,50]))&&(p2bodydist y=[-75,-30])
value=Cond(Var(2),1700,1500)

[State 0, Special 1: Spinning Blue Orby Thingy]
Type = ChangeState
triggerall = StateType != A
Triggerall = Power >= 1000
Triggerall = AILevel > 0 && RoundState = 2
...
Trigger1 = Random < (AILevel * 100)/Cond(Pos Y >= 0,2,3)
Value =  Cond(Var(2),Cond(Random >= 500,1600,Cond(Power >= 2000 && Random >= 500,1800,1900)),Cond(Random >= 500,Cond(Random >= 500,1200,Cond(Random >= 500,1400,1000)),Cond(Random >= 500,1300,Cond(Random >= 500,1400,1100))))

[State 0, Special 2: Shield]
type = ChangeState
triggerall = power >= 1000
triggerall = statetype != A
triggerall = !NumHelper(1130)
triggerall = ailevel > 0 && roundstate = 2
triggerall = ctrl 
triggerall = var(30)
...
[State 0, The World: Toki wo tomare! React]
type = ChangeState
Triggerall = Var(30)
triggerall = !(stateno = 11000 || stateno = 11050)
Triggerall = !IsHelper
triggerall = numhelper(565) = 1
triggerall = numhelper(5601) = 0
triggerall = power >= 1000
...
[State 0, The World: Toki wo tomare! React with LautyCarp's Jotaro]
type = ChangeState
triggerall = !(stateno = 11000 || stateno = 11050)
Triggerall = !IsHelper
triggerall = numhelper(5601) = 0
...
triggerall = movetype != H
triggerall = ailevel > 0 && roundstate = 2
triggerall = enemynear,name = "Jotaro Kujo" && enemynear,authorname = "LautyCarp"
triggerall = enemynear,stateno = 1300
triggerall = enemynear,time = [30,40]
trigger1 = 1
value = 11000

[State 0, The World: Toki wo tomare!]
type = ChangeState
triggerall = numhelper(5601) = 0
triggerall = numhelper(570) = 0
Triggerall = Var(30)
triggerall = !((partner,name = "Dio Brando" && partner,authorname = "Knidds" || Partner,Name = "Thanos [Kuro]") && partner,numhelper(570) = 1)
triggerall = power >= 1000
triggerall = p2movetype != H
triggerall = ailevel > 0 && roundstate = 2
triggerall = ctrl
triggerall = (abs(p2bodydist x) + abs(p2bodydist y)) > 100
triggerall = !(p2stateno = 5110 || p2stateno = 5120 || p2stateno = 5150 || p2stateno = 5201 || p2stateno = 5210)
Triggerall = !IsHelper
...
trigger1 = random < (ailevel * 100)/1.6
value = 25000
...
triggerall = statetype != A
triggerall = ailevel
Triggerall = !NumHelper(3880)
triggerall= enemynear,pos y>= -const(size.height)*1.6
trigger1 = random < ((ailevel * 100)*enemy, gethitvar(hitcount)*50)
trigger2 = random < (ailevel * 90+enemy, gethitvar(hitcount)*5)/2
value = Cond(Var(2),3100,3000)
...
type = NotHitBy
Trigger1 = Stateno = 65
trigger2 = NumExplod(34365) 
value = SCA,NA,SA,HA,NP,SP,HP,NT,ST,HT
time = 1

[State 0, RemoveExpold]
Type = RemoveExplod
Trigger1 = NumExplod(34365) 
Trigger1 = MoveType = H || (Stateno = [0,80])
ID = 34365
...
type = changestate
triggerall = !var(59)
triggerall = (roundstate = 2) && ((ctrl) || (stateno = [100, 111]) || (numhelper(99999))) && (!numexplod(60))
...
type = pause
triggerall = (numhelper(98511)) && (pos y != 0) && (enemy, movetype = h)
trigger1 = (movetype = i) && (time % 2 = 0)
time = 2
movetime = 2
[state > taunt fix]
type = assertspecial
...
[State 0, SelfState] ; Taunt
Type = SelfState
Triggerall = !Var(48) && !Var(59) && !Var(2) && !Var(30) && Stateno != 82130 && Stateno != 360039 && Stateno != 700 && Stateno != 99615 && Stateno != 1822
Trigger1 = Life <= 1000
Value = 82130
IgnoreHitPause = 1

[State 0, SelfState] ; Mana Zone bs
Type = SelfState
Triggerall = Var(48) && !Var(59) && Var(2) && !Var(30) && Stateno != 82130 && Stateno != 360039 && Stateno != 700 && Stateno != 99615 && Stateno != 1822
Trigger1 = Life <= 600
Value = 99615
...
[State 0, SelfState] ; Star Magic Bs
Type = SelfState
Triggerall = Var(48) && Var(59) && !Var(30) && Var(2) && Stateno != 82130 && Stateno != 360039 && Stateno != 700 && Stateno != 99615 && Stateno != 1822
Trigger1 = Life <= 150
Value = 1822
IgnoreHitPause = 1
...
[state 0]
type = changestate
trigger1 = ailevel && Enemy,Pos Y >= 0
...
type = PosAdd
trigger1 = Time >= 20
x= 16*((p2bodydist x -0)/(abs(p2bodydist x - 0) + abs(p2bodydist y - 20) + 0.0000001))
y= 16*((p2bodydist y -20)/(abs(p2bodydist x- 0)+abs(p2bodydist y - 20) + 0.0000015))
[state 0]
type = statetypeset
trigger1 = pos y != 0
physics = a
...
type = velset
trigger1 = time >= 15
x = cond(p2bodydist x <= 80, 4, 8)
y = cond(p2bodydist x <= 80, const(movement.yaccel) * -.1 + (p2bodydist y / 12), const(movement.yaccel) * -.15 + (p2bodydist y / 15))
...
trigger1 = (time >= 15) && ((numhelper(81001)) && (helper(81001), movecontact))
...
trigger1 = command = "a"
trigger2 = roundstate = 2 && ailevel > 0 && p2bodydist x < 40 && random < (ailevel * 100)

; B
[State -1, B]
type = ChangeState
value = Cond(Pos Y >= 0,300,610)
trigger1 = command = "b"
trigger2 = roundstate = 2 && ailevel > 0 && p2bodydist x < 40 && random < (ailevel * 100)/2

; C
[State -1, C]
type = ChangeState
value = Cond(Pos Y >= 0,400,620)
Triggerall = !numhelper(451) && !NumHelper(450) && !NumHelper(452)
triggerall = Pos Y >= 0
trigger1 = command = "c"
trigger2 = roundstate = 2 && ailevel > 0 && p2bodydist x > 100 && random < (ailevel * 100) 
...
type = velset
trigger1 = !time
x = const(velocity.run.fwd.x) * 2.2
...
type = velset
trigger1 = time = 1
x = cond(pos y != 0, (const(velocity.run.fwd.x) * 2 / 2), (const(velocity.run.fwd.x) * 2))*2.5
y = cond(pos y != 0, -3, 0)
...
ignorehitpause = 1
persistent = 0
[State 0, NotHitBy] ; Not Be Able To Get Hit In This State
Type = NotHitBy
Trigger1 = 1
Value = SCA,NA,SA,HA,NP,SP,HP,NT,ST,HT
Time = 1
...
trigger4 = ((ailevel) && (time >= 120 + (random % 140)))
...
[state 0]
type = changestate
triggerall = cond(ailevel = 0, time >= 30, 1)
trigger1 = ((!ailevel) && (command = "s"))
trigger2 = ailevel
trigger3 = time >= 900
value = 190
...
[state 0]
type = changestate
trigger1 = (ailevel) || ((partner, stateno != 5903) && (partner, time >= 80))
value = 5903
...
triggerall = teammode != simul
trigger1 = time = [30, 40]
pos = ((pos x) / (1 / camerazoom * 2)) * camerazoom, (pos y + cond(root, statetype = a, 20, 0)) / (1 / camerazoom * 2) * camerazoom
lag = .7
scale = 1
ignorehitpause = 1
...
[state 0]
type = bindtoroot
trigger1 = ((root, name != "annie leonhart") && (root, stateno != [4000, 4999]))
...
type = bindtoroot
trigger1 = ((root, name = "annie leonhart") && (root, stateno = [4000, 4999]))
pos = (root, const(size.head.pos.x) + 12), -(root, const(size.height) + 62)
[state 0]
type = assertspecial
trigger1 = 1
flag = noshadow
...
trigger2 = ((!ailevel) && ((time = 120) || (root, life = 0) || (roundstate != 2)))
trigger3 = ((ailevel) && (root, life = 0) || (roundstate != 2))
trigger4 = (numhelper(81007)) && (numhelper(98510))
value = 99011
...
type = changeanim
trigger1 = 1
value = 5021 + (cond(animexist(6300) && (var(10)), (var(10)), 0))
elem = 1
...
type = lifeadd
trigger1 = numhelper(30990)
value = cond((helper(30990), var(1)) = 4, 6, 2)
ignorehitpause = 1
