...
[State -1, Aura Explosion]
type = ChangeState
triggerall = numhelper(20100)=0
triggerall = power >= 1500 && (enemynear(var(59)),stateno!=[5200,5210]) && (var(2)=0 || var(2)=2) && enemynear(var(59)),stateno !=1210 && cond(enemynear(var(59)),stateno = 5120,enemynear(var(59)),animtime > -7,1)
...
triggerall = power >= 2500 && statetype != A && cond(enemynear(var(59)),stateno = 5120,enemynear(var(59)),animtime > -3,1)
...
triggerall = numhelper(40100)=0
Triggerall = (var(2) = 1 || var(2) = 3)
triggerall = power >= 2500 && statetype != A 
