...
[command]
name = "SPECIAL 7"     ; Baixo + Frente + S
command = ~D,DF,F,s
time = 15

[command]
name = "SPECIAL 8"     ; Baixo + Tras + S
command = ~D,DB,B,s
time = 15
...
[State -1, 通灵外道魔像]
type = ChangeState
Triggerall = !Helper(30990),Fvar(11)
...
[State -1, 通灵外道魔像]
type = ChangeState
Triggerall = !Helper(30990),Fvar(12)
Triggerall = !Numhelper(94105)
triggerall = ailevel = 0
triggerall = var(2) = 0
...
[State -1, 通灵外道魔像]
type = ChangeState
Triggerall = !Helper(30990),Var(11)
triggerall = ailevel = 0
triggerall = var(2) = 0
Triggerall = power >= 3000
...
type = ChangeState
triggerall = ailevel = 0
triggerall = var(2) = 0 && !numhelper(91660)
Triggerall = power >= 500
value = 1600+var(11)
...
type = ChangeState
triggerall = ailevel = 0
triggerall = var(2) = 0 && !numhelper(91750)
Triggerall = power >= 500
value = 1700+var(11)
...
[State -1, 通灵秽土人柱力]
type = ChangeState
Triggerall = !Helper(30990),Fvar(7)
Triggerall = !Numhelper(23005)
triggerall = ailevel = 0
triggerall = var(2) = 0
