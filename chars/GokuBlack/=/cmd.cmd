...
Trigger1 = (Cond(Stateno = 500 || Stateno = 501 || Stateno = 60 || Stateno = 61 || Stateno = 65 || Stateno = 66 || Stateno = 70 || Stateno = 80,!Ctrl,Ctrl))
Trigger1 = (Fvar(39) < 200/5 && (EnemyNear, MoveType = A || EnemyNear, NumProj > 0)) || InGuardDist
Value = 99600
[State -1, Special 2: Counter (BackUp)] 
Type = ChangeState
TriggerAll = Var(12)
TriggerAll = Var(13)
TriggerAll = StateNO != 99600
...
Trigger1 = Var(20) = [(0 * AiLevel),(2 * AiLevel)]
Trigger1 = Fvar(39) <= 200/5
Trigger1 = EnemyNear,Pos Y >= Const(Size.Mid.Pos.Y)
Value = 99600
IgnoreHitPause = 1
[state > ai - parry]
type = changestate
...
trigger2 = (ailevel) && (roundstate = 2) && (ctrl) && ((p2bodydist x >= 180) && (random < (ailevel * 1) / 5))
...
trigger3 = ((ailevel) && ((p2bodydist x = [12 + (random % 4), 26]) && (p2bodydist y = [-10, 5]) && (enemynear, stateno = [120, 150])) && (random < (ailevel * 10)))
value = 112
[state > grab counter]
type = hitoverride
triggerall = !var(59)
...
trigger1 = (((gametime % 5 = 0) && ((numhelper(99100) && ((helper(30990), var(1)) = 4)))) || ((gametime % 15 = 0) && (numhelper(99100))))
...
;type = AngleDraw
;trigger1 = time > 19
;value = ((atan((-1*Vel Y)/ceil(Vel X+1)))*(360/(2*pi)))
;ignorehitpause = 1
...
triggerall = time > 2
Triggerall = Helper(81001),MoveHit
trigger1 = command = "a"
...
[State -1, C]
type = ChangeState
value = Cond(Pos Y >= 0,400,620)+Var(11)
triggerall = time > 2
Triggerall = Helper(81001),MoveHit
trigger1 = command = "c"
trigger2 = roundstate = 2 && ailevel > 0 && p2bodydist x > 100 && random < (ailevel * 100) && Pos Y >= 0
...
[state 0]
type = changestate
trigger1 = ((time >= 60) || ((time >= 30) && (frontedgebodydist <= 30)))
value = cond(pos y != 0, 111, 101)
ctrl = 0
...
trigger1 = !animtime
value = Cond(random<700,11500,4200)
ctrl = 1
[state 0]
type = changestate
triggerall = var(2) = 1
...
triggerall = random < (ailevel * 25)
trigger1 = !animtime
value = Cond(random<700,4001,4002)
ctrl = 1
[state 0]
type = changestate
triggerall = var(2) = 1
...
triggerall = random < (ailevel * 25)
trigger1 = !animtime
value = Cond(random<700,4400,4500)
ctrl = 1
[state 0]
type = changestate
triggerall = var(2) = 1
...
triggerall = random < (ailevel * 25)
trigger1 = !animtime
value = Cond(random<700,2200,2300)
ctrl = 1
...
trigger1 = !animtime
value = Cond(random<700,1000,1100)
ctrl = 1
[state 0]
type = changestate
triggerall = var(2) = 0
...
triggerall = random < (ailevel * 30)
trigger1 = !animtime
value = Cond(random<700,1200,1300)
ctrl = 1
[state 0]
type = changestate
triggerall = var(2) = 0
...
triggerall = random < (ailevel * 30)
trigger1 = !animtime
value = Cond(random<700,1400,1500)
ctrl = 1
[state 0]
type = changestate
triggerall = var(2) = 0
...
triggerall = teamside = 1
trigger1 = roundno = 1
value = cond((id = 56), 5903, 0)
[state 0]
type = changestate
triggerall = numpartner
triggerall = teamside = 2
trigger1 = roundno = 1
value = cond(id = 57 + (enemy, numpartner), 5903, 0)
...
[state 0]
type = changestate
trigger1 = (movecontact) || (frontedgebodydist < 0) || (pos y >= -5) || (time >= 280)
value = 20001
...
[state 0]
type = playsnd
triggerall = (name = "ainz ooal gown") || (name = "crypto")
trigger1 = !time
value = s9850, 7
[state 0]
type = playsnd
...
[state 0]
type = destroyself
trigger1 = (roundstate != 2) || (root, life = 0) || (time >= 20000000)
