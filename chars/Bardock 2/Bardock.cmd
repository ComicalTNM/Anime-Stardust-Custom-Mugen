...
type = ChangeState
triggerall = power>=1000
value =cond(pos y <=-1,1302,1300)
triggerall = command ="SPECIAL 4"
trigger1 = ctrl
trigger2 = (stateno =[200,203] )&& movecontact
trigger3 =  (stateno =[300,301] ) &&movecontact
trigger4 = (stateno =[600,606] )&& movecontact
[State -1, A]
type = ChangeState
...
[State -1, B]
type = ChangeState
triggerall = cond(command="holddown",var(54)=0,var(51)=0)
...
value = cond(command="holddown",400,400)
...
[State -1, B Aire]
type = ChangeState
triggerall =  cond(command="holddown",var(54)=0,1)
triggerall = var(2)<=1 
value = cond(command="holddown",330,605)
triggerall = command = "b" || (command = "b"&&command = "holddown")
Triggerall = statetype = A
trigger1 = ctrl
