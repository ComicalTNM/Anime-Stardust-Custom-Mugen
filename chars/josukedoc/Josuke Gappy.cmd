...
trigger13 = stateno = 480 && helper(340),movecontact
;===========================================================================
; SUPER:
;===========================================================================
; Here's your receipt
...
Triggerall = power >= 2000
value = Cond(numexplod(2600),2700,2600)
...
trigger3 = stateno = 210 && movecontact
trigger4 = stateno = 220 && movecontact
trigger5 = (stateno = [250,260]) && movecontact
trigger6 = stateno = 300 && helper(340),movecontact
trigger7 = stateno = 310 && helper(340),movecontact
trigger8 = stateno = 320 && helper(340),movecontact
trigger9 = stateno = 400 && helper(340),movecontact && time > 20
;---------------------------------------------------------------------------
; ORA ORA ORA!
[State -1, ORA ORA ORA!]
type = ChangeState
...
trigger13 = stateno = 480 && helper(340),movecontact && time > 7
;---------------------------------------------------------------------------
