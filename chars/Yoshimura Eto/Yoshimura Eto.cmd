...
triggerall = NumHelper(2456)  < 1
Triggerall = power >= 500
Triggerall = var(3) = 0
Triggerall = var(11) = 0
value = 510
triggerall = command = " 青铜树 "
trigger1 = statetype != A
trigger1 = ctrl
;---------------------------------------------------------------------------
[State -1, 独眼的枭 赫 ]
