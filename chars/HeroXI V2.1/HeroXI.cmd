...
trigger10 = stateno = 360 && movecontact
trigger11 = stateno = 410 && helper(415), movecontact
...
triggerall = command = "Especial 11"
trigger1 = (statetype = s) && ctrl
;---------------------------------------------------------------------------
[State -1, Kaboom]
type = ChangeState
