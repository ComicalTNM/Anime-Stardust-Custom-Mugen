...
[State -1, Zaga Teppo]
type = ChangeState
triggerall = (power >= 3000) && (command = "x") && (statetype != A) && (p2life <= lifemax/3) && (teammode != simul)
...
type = ChangeState
triggerall = !Var(23)
triggerall = (power >= 3000) && (command = "y") && (statetype != A) && (p2life <= lifemax/3) && (teammode != simul)
triggerall = numhelper(1960) = 0
trigger1 = ctrl
value = 3000
