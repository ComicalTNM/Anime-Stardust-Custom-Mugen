...
triggerall = command = "a" && command = "b" && command = "c"  && command = "x" 
trigger1 = statetype != A
trigger1 = ctrl
...
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = movecontact && (stateno = 200||stateno = 210||stateno = 220||stateno = 230||stateno = 240||stateno = 250||stateno = 350||stateno = 310||stateno = 320||stateno = 400||stateno = 410||stateno = 421)
