...
triggerall = numhelper(1745355) = 0
Triggerall = !ishelper
Triggerall = (Enemynear,stateno >= 200+(enemynear,Var(11))&& Enemynear,stateno < 1000+(enemynear,Var(11)))
Triggerall = Incustomstate && Name = "Frieza(JT)"
trigger1 = P2BodyDist x < 30 && random < (ailevel * 100)/10
value = 73011
...
triggerall = ((movetype = h) || (numhelper(98001) = 1))
triggerall = enemy, numhelper(80015) = 0
trigger1 = (p2bodydist x = [-47 + (random % 4), 50 + (random % 10)]) && (random < (ailevel * 2))
attr = sca, na, np, nt, sa, sp, st
stateno = 99685
time = 5
ignorehitpause = 1
...
size.head.pos = 90, (Helper(30990),var(53))
supermovetime = 999
pausemovetime = 999
size.xscale = 1.0
size.yscale = 1.0
...
type = changeanim
triggerall = pos y < 0
trigger1 = (time >= 15) && (anim != Cond(SelfAnimExist(100+var(11)),100,Cond(SelfAnimExist(60+var(11)),60,20)) + (var(11)))
value = Cond(SelfAnimExist(100+var(11)),100,Cond(SelfAnimExist(60+var(11)),60,20)) + (var(11))
elem = 1
[state 0]
type = changeanim
triggerall = pos y >= 0
trigger1 = (time >= 15) && (anim != Cond(SelfAnimExist(100),100,Cond(SelfAnimExist(60),60,20)) + (var(11)))
value = Cond(SelfAnimExist(100+var(11)),100,Cond(SelfAnimExist(60+var(11)),60,20)) + (var(11))
elem = 3
...
angle = 0
ownpal = 1
remappal = 3, (Helper(30990),var(53))
removeongethit = 1
ignorehitpause = 1
supermovetime = 999
pausemovetime = 999
...
time = 1
add = (floor(Helper(30990),Fvar(35))), (floor(Helper(30990),Fvar(36))), (floor(Helper(30990),Fvar(37)))
color = 256
[state 0]
type = afterimage
trigger1 = time = 15
...
length = 5
palcolor = 256
palbright = (floor(Helper(30990),Fvar(35)) * 2), (floor(Helper(30990),Fvar(36)) * 2), (floor(Helper(30990),Fvar(37)) * 2)
palcontrast = (floor(Helper(30990),Fvar(35)) * 2), (floor(Helper(30990),Fvar(36)) * 2), (floor(Helper(30990),Fvar(37)) * 2)
paladd = (floor(Helper(30990),Fvar(35)) * 2), (floor(Helper(30990),Fvar(36)) * 2), (floor(Helper(30990),Fvar(37)) * 2)
timegap = 1
framegap = 1
trans = add1
...
Trigger1 = command = "a"
Trigger2 = roundstate = 2 && ailevel > 0 && p2bodydist x < 25 && random < (ailevel * 100)
value = Cond(random>=500,200,2300)
; A
[State 200, Into Dash+A]
type = ChangeState
Triggerall = var(2) = 2
Triggerall = Time >= 4
Trigger1 = command = "a"
Trigger2 = roundstate = 2 && ailevel > 0 && p2bodydist x < 45 && random < (ailevel * 100)
value = Cond(random>=500,40200,40300)
[state 0]
type = changestate
...
velset = 0, 0
ctrl = 0
anim = Cond(var(2)=2,40112,112 + (var(11)))
sprpriority = 2
facep2 = 1
...
[State 0, TargetState]
type = TargetState
triggerall = p2stateno != [116000,116999]
trigger1 =  movehit
value = 116000+enemynear,statetype = C*10+enemynear,statetype = A*20
