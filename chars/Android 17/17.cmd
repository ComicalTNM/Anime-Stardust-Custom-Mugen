...
trigger1 = ctrl || stateno = 400 || stateno = 620
trigger2 = numhelper(700)>0
trigger2 = stateno != [1300,1380]
trigger3 =  stateno = 1400 && movehit
trigger4 =  stateno = 1760 && movehit
trigger5 =  stateno = [1800,1830]
trigger5 =  movecontact
trigger6 =  stateno = [1100,1290]
trigger6 =  movecontact
trigger7 =  stateno = [1800,1890]
trigger7 =  movecontact
trigger8 =stateno = 1281 && animelemtime(6)>2
[State -1, C]
type = ChangeState
triggerall = power >= 1000
triggerall = ailevel = 0 && roundstate = 2
...
type = ChangeState
triggerall = ailevel = 0 && roundstate = 2
value = Cond(numexplod(1400),1410,1400)
triggerall = Cond(numexplod(1400),1,Statetype != A)
...
value = 750
triggerall = (command = "holdfwd" && command = "s")||command = "y"
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
value = 45
trigger1 = (stateno = 600||stateno = 610||stateno = 611||stateno = 615||stateno = 616) && movecontact
trigger2 = var(50)&&numhelper(700)
; Air Dash Forward
...
triggerall = ailevel = 0 && roundstate = 2
value = 80
trigger1 = command = "Super Jump"|| (command = "hold_x"&& command = "up")
...
trigger1 =  command = "z"
trigger1 = AILevel <=  0
trigger4 = stateno = 370 && time = 1 && ailevel > 5 && var(50)=0
trigger2 = stateno = 600 && (numexplod(12) = 0||numexplod(14)) && time >= 1 && ailevel > 5
trigger3 = stateno = 1400 && movecontact && ailevel
ignorehitpause = 1
